...
@interface CBDViewController () <GLKViewControllerDelegate>
{
    ...
    CardboardSDK::DistortionRenderer *_distortionRenderer; ///失真渲染器
                          ...
                          rightEye:(CardboardSDK::Eye *)rightEye
{
    ...
    glEnable(GL_SCISSOR_TEST);///根据函数glScissor设置，启用图形剪切
    leftEye->viewport()->setGLViewport();
    leftEye->viewport()->setGLScissor(); //裁剪函数
